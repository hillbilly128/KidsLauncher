...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
					int shortAnimTime = LoginActivity.this.getResources()
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.activity_parentlogin);

		mFragmentContainer = this.findViewById(R.id.fragment_container);

		// Set up the login form.
		mEmailView = (AutoCompleteTextView) this.findViewById(R.id.email);
//		this.populateAutoComplete();
		...
		Button mEmailSignInButton = (Button) this
		...
		mProgressView = this.findViewById(R.id.login_progress);
	}
